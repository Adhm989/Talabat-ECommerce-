    ...
    public partial class OrderEntities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Odrers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Odrers_DeliveryMethods_DeliveryMethodId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_Odrers_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Odrers",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_Odrers_DeliveryMethodId",
                table: "Odrers",
